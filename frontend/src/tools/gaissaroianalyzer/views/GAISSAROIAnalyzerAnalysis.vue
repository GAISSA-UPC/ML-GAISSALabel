...
// Import components
import ModelInformationCard from '../components/ModelInformationCard.vue';
import SourceInformationCard from '../components/SourceInformationCard.vue';
import TacticSourcesCard from '../components/TacticSourcesCard.vue';
